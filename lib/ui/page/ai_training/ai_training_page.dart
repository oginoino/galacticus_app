...
class AiTrainingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<AiTrainingProvider>();
    ...
    return Scaffold(
      ...
      body: ContentStateView(
        ...
        onRetry: provider.loadAiTraining,
